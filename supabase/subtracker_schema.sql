...
CREATE TABLE contractor_insurance_history (
    id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE INDEX idx_contractor_insurance_history_contractor_created
...
CREATE TABLE contractor_followups (
    id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    contractor_id INTEGER NOT NULL,
    compliance_record_id INTEGER,
...
CREATE INDEX idx_contractor_followups_contractor_date
